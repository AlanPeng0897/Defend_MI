...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'auto8': dict(ref_gpus=-1, kimg=25000, mb=-1, mbstd=-1, fmaps=-1, lrate=-1, gamma=-1, ema=-1, ramp=0.05, map=8),
        # Populated dynamically based on resolution and GPU count.
...
@click.option('--cfg', help='Base config [default: auto]',
              type=click.Choice(['auto', 'auto8', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar']))
...
@click.option('--resume_from_prev',
              help='Resume training from previous run (for handling preemption/ckpting) [default: 0 ]', type=int,
              metavar='INT')
# Performance options.
