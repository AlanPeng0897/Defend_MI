...
class ConditionalGenerator(nn.Module):
    def __init__(self, imgSize, nz, ngf, nc, n_conditions, is_conditional, sn, z_scale,
                 conditioning_method, embed_condition=True, norm='bn', cdim=128):
...
class ConditionalGeneratorSecret(nn.Module):
    def __init__(self, imgSize, nz, ngf, nc, n_conditions, is_conditional, sn, z_scale, conditioning_method,
                 embed_condition=True, norm='bn', cdim=128):
...
class DiscriminatorKPlusOne(nn.Module):
    ...
    def __init__(self, imgSize, nc, ndf=64, is_conditional=False, n_conditions=1, sn=False, num_SVs=1, num_SV_itrs=1,
                 SN_eps=1e-12, index2class=None, embed_condition=True, output_type='standard', use_sigmoid=True,
                 cdim=128):
...
class Discriminator0(DiscriminatorBase):
    ...
    def __init__(self, imgSize, nc, ndf=64, is_conditional=False, n_conditions=1, sn=False, num_SVs=1, num_SV_itrs=1,
                 SN_eps=1e-12, index2class=None, embed_condition=True, output_type='standard', use_sigmoid=True,
                 cdim=128):
        super(Discriminator0, self).__init__(imgSize, nc, ndf=ndf, is_conditional=is_conditional, sn=sn,
                                             n_conditions=n_conditions,
                                             index2class=index2class, embed_condition=embed_condition,
                                             output_type=output_type, use_sigmoid=use_sigmoid, cdim=cdim)
...
class DiscriminatorSecret(DiscriminatorBase):
    ...
    def __init__(self, imgSize, nc, ndf=64, is_conditional=False, n_conditions=1, sn=False, num_SVs=1, num_SV_itrs=1,
                 SN_eps=1e-12, index2class=None, embed_condition=True, output_type='standard', use_sigmoid=True,
                 cdim=128):
        super(DiscriminatorSecret, self).__init__(imgSize, nc, ndf=ndf, is_conditional=is_conditional, sn=sn,
                                                  n_conditions=n_conditions,
                                                  index2class=index2class, embed_condition=embed_condition,
                                                  output_type=output_type, use_sigmoid=use_sigmoid, cdim=cdim)
...
class DiscriminatorResNet(DiscriminatorBase):
    ...
    def __init__(self, imgSize, nc, ndf=64, is_conditional=False, n_conditions=1, index2class=None, sn=False,
        ...
        super(DiscriminatorResNet, self).__init__(imgSize, nc, ndf=ndf, is_conditional=is_conditional,
                                                  n_conditions=n_conditions, index2class=index2class,
...
class DiscriminatorToy(DiscriminatorBase):
    ...
    def __init__(self, imgSize, nc, ndf=64, is_conditional=False, n_conditions=1, index2class=None, sn=False):
        ...
        super(DiscriminatorToy, self).__init__(imgSize, nc, ndf=ndf,
                                               is_conditional=is_conditional, n_conditions=n_conditions,
